...
#         # Sort the list elements (convert dicts to tuples for comparison stability)
#         sorted_list = sorted(
#             actual,
...
#                 actual_str = ET.tostring(actual_body, encoding='unicode') if actual_body is not None else "None"
